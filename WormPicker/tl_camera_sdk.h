...
/// </summary>
/// <param name="tl_camera_handle">The camera handle associated with the image width request.</param>
/// <param name="width">A reference that receives the value in pixels for the current image height.</param>
/// <returns>0 if successful or a positive integer error code to indicate failure.</returns>
...
/// <param name="width">A reference that receives the value in pixels for the sensor width.</param>
/// <returns>0 if successful or a positive integer error code to indicate failure.</returns>
...
/// Any attempt to do so is not permitted and could result in undefined behavior.
/// </summary>
/// <param name="tl_camera_handle">The handle to the camera to terminate.</param>
/// <returns>0 if successful or a positive integer error code to indicate failure.</returns>
...
extern "C"
{
    ...
    extern TL_CAMERA_GET_EXPOSURE_RANGE tl_camera_get_exposure_time_range;
