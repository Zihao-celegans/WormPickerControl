...
int tl_camera_sdk_dll_initialize(void)
{
	...
	load_module = (LOAD_MODULE)get_kernel_function((char*) "load_module");
	unload_module = (UNLOAD_MODULE)get_kernel_function((char*)"unload_module");
	get_module_function = (GET_MODULE_FUNCTION)get_kernel_function((char*)"get_module_function");
